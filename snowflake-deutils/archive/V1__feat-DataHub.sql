...
-- ************************** SqlDBM: Snowflake *************************
-- ********** Generated by SqlDBM: DATA_HUB by frankf@ultra.me **********
...
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Trigger_Type TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Transfer_Method TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Storage_Method TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Status TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Method TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Interval TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_Interface TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.REF_File_Format TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Contact TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Publisher TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Publication TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Subscriber TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Subscription TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
GRANT OWNERSHIP ON TABLE ULTRA_@ENV@_RAW.DATA_HUB.Issue TO ROLE ULTRA_@ENV@_RAW_DATA_HUB_ADMIN COPY CURRENT GRANTS;
