...
- **Main Documentation:** [Confluence - eimutils](https://kaena1.atlassian.net/wiki/spaces/EIM/pages/3109683221/eim_deutils)
- **Database Schema:** `Database/Control/Tables/` in repository
- **Migration History:** `database_change/` for schema evolution
- **Package Versions:** [Package Upgrades History](https://kaena1.atlassian.net/wiki/spaces/EIM/pages/4054351977/Package+Upgrades+eimutils+1.5.0)
