...
│ - ContactName   │    │ - SubscriberCode │   │ - Step_Status   │
│ - InterfaceCode │    │ - IsActive       │   │ - Step_Desc     │
└─────────────────┘    └─────────────────┘    └─────────────────┘
         │
         │
         v
...
```bash
streamlit run dhui/snowflake_streamlit_app.py
```
...
> **Note:** The System Analytics page is planned for a future release and is not yet available in the current version.
