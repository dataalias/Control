...
GRANT USAGE ON SEQUENCE MYDB_@ENV@_RAW.DATA_HUB.SEQ__STEP_LOG_ID TO ROLE PIPELINE_@ENV@_SVC;
GRANT OWNERSHIP ON TABLE MYDB_@ENV@_RAW.DATA_HUB.STEP_LOG TO ROLE MYDB_@ENV@_RAW__DATA_HUB__ADMIN COPY CURRENT GRANTS;
