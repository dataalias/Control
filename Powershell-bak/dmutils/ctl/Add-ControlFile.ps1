...
.EXAMPLE
Add-ControlFile -dir "\\<MY_FILE_SHARE_SERVER>\bi_admin_qa\FileShare\Civitas\inbound" -pc "Inspire_Engagement_Report" -fm "Inspire_Engagement_Report_([0][1-9]|[1][0-2])-([0][1-9]|[1][0-9]|[2][0-9]|[3][0-1])-([19]|[20])\d{2}"
