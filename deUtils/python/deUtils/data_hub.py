...
from deUtils.data_hub_connection import connect_database, get_publication_list, prepare_issues, insert_new_issue, update_issue, is_issue_absent, notify_subscriber_of_distribution
...
class DataHub:
    ...
    def get_publication_list(self, params):
        ...
        try:
            ...
            self.publication_list = get_publication_list(self.db_connection, params, self.get_type)
            self.issue_list = prepare_issues(self.publication_list, self.get_type)
    ...
    def insert_new_issue(self):
        ...
        try:
            ...
            issue_id = insert_new_issue(self.db_connection, self.issue_list[self.publication_idx])
    ...
    def update_issue(self, issue):
        ...
        try: 
            ...
            response = update_issue(self.db_connection, self.issue_list[self.publication_idx])
            self.db_connection.commit()
    ...
    def notify_subscriber_of_distribution(self):
        ...
        try:
            ...
            response = notify_subscriber_of_distribution(self.db_connection,
...
ffortunato  20230918    ~ working with imports...
*******************************************************************************
"""
