...
//		echo "<img src='/images/icons/lightning.png'> <font class='darkblue-14px'><b>Recent Activity</b></font>";
		echo "<img src='/images/icons/monitor.png'> <font class='darkblue-14px'><b>Issue Activity</b></font>";
		...
		echo "<table id='rt-darkblue' width='1200' border='0' cellspacing='0' cellpadding='3'>";
			...
			while ($row_getRecentActivityList = sqlsrv_fetch_array($stmt_getRecentActivityList, SQLSRV_FETCH_ASSOC)){
				...
				$RowColor++;
					...
					printf('<td><a href="view-issue.php?iid=%s"><font class="darkgrey-11px">%s</font></a></td>', $row_getRecentActivityList['IssueId'], iconv("Windows-1252", "UTF-8", $row_getRecentActivityList['IssueName']));
